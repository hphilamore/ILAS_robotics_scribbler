...
int main()                                    // Main function
{
  ...
  if (s3_resetButtonCount() == 1) {
    ...
    while(1)
    {
      ...
      int output = arbitrate();
      
      print("%d, %d, %d, %d\n", SenseObstacle, SenseLightSide, SenseLightFront, output);
...
int arbitrate(void){
  // 
  if(SenseObstacle){return 1;}
  else if(SenseLightSide){return 2;}
  else if(SenseLightFront){return 3;}
}  
