...
if (s3_resetButtonCount() == 1) {
   ...
   static float x_pos[6] = {100, 200, 400, 450}; 
 
   static float y_pos[6] = {200, 100, 170, 130};
   
   static int mark[6] = {1, 1, 1, 1}; 
  ...
  if (s3_resetButtonCount() == 2) {
   ...
   static float x_pos[6] = {0,    0,     100, 100,   100,  200}; 
 
   static float y_pos[6] = {-200, -100, -100, 0,    -200, -200};
   
   static int mark[6] = {1, 0, 1, 1, 1, 0}; 
...
void pen_lift(int pose){
  if(pose){servo_angle(5, 10 * 90);}
  else{servo_angle(5, 10 * 45);}
} 
